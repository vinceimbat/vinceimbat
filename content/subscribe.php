<?php 
	...
	$sendy_installation_url = 'https://sendy.lawak.ph'; //Your Sendy installation (without the trailing slash)
	$api_key = 'xOyur54aE6ghxiXEroYa'; //Can be retrieved from your Sendy's main settings
